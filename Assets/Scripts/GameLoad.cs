...
public class GameLoad : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (!File.Exists(Path.Combine(Application.persistentDataPath, "GameData.xml")))
        {
            ...
            xmlDoc.Save(Path.Combine(Application.persistentDataPath, "GameData.xml")); //Save puzzles.xml to persistentdatapath
        }
        ...
        xmlPersist.Load(Path.Combine(Application.persistentDataPath, "GameData.xml")); //Load puzzles.xml from persistentdatapath
